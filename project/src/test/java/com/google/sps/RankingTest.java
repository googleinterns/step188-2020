...
import com.google.sps.utilities.EventRanking;
...
public final class RankingTest {
  ...
  public void testRankingEmptyEvents() throws IOException {
    Assert.assertEqual(new ArrayList<Event>(), EventRanking.rankEvents(new HashSet<Event>()));
  }
  ...
  public void testRankingUntiedEvents() throws IOException {
    ...
    List<Event> actualEventRanking = EventRanking.rankEvents(USER_CONSERVATION_FOOD_MUSIC, eventsToRank);
