...
public final class OpportunitySignupDataTest {
  ...
  @Test
  public void testGetSignups_OpportunityNotSpecified() throws IOException {
    Mockito
    ...
    Mockito.verify(response)
        .sendError(HttpServletResponse.SC_BAD_REQUEST, String.format("No opportunity specified."));
  }
 
  @Test
  public void testGetSignups_OpportunityIdNotInDatabase() throws IOException {
