...
public final class CommonUtilsTest {
  ...
  public void volunteeringOpportunityToJson() {
    ...
    VolunteeringOpportunity opportunity = new VolunteeringOpportunity.Builder(name, numSpotsLeft)
    ...
    String expectedJson = String.format(
        "{%s:%s,%s:%s,%s:%d,%s:%s,%s:[{%s:%s,%s:%s,%s:%s,%s:%s,%s:%s,%s:%s,%s:%s}]}",
          wrapInQuotes("opportunityId"), wrapInQuotes(opportunity.getOpportunityId()),
          wrapInQuotes("name"), wrapInQuotes(name),
          wrapInQuotes("numSpotsLeft"), numSpotsLeft,
          wrapInQuotes("requiredSkills"), new HashSet<String>(Arrays.asList(wrapInQuotes(requiredSkill))), 
          wrapInQuotes("volunteers"),
          wrapInQuotes("name"), wrapInQuotes(volunteer.getName()),
          wrapInQuotes("email"), wrapInQuotes(volunteer.getEmail()),
          wrapInQuotes("interests"), volunteer.getInterests(),
          wrapInQuotes("skills"), volunteer.getSkills(),
          wrapInQuotes("eventsHosting"), volunteer.getEventsHosting(),
          wrapInQuotes("eventsParticipating"), volunteer.getEventsParticipating(),
          wrapInQuotes("eventsVolunteering"), volunteer.getEventsVolunteering());
